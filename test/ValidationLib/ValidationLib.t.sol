...
import { ValidationLib, InvalidTypedString, REASON_INVALID_PREFIX, REASON_TokenAmount_MISMATCH } from "@BondRoute/ValidationLib.sol";
...
contract ValidationLibTest is Test {
    ...
    function test_validate_typed_string_prefix_rejects_too_short() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, short_string, REASON_INVALID_PREFIX ) );
    ...
    function test_validate_typed_string_prefix_rejects_wrong_word1() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, wrong_word1, REASON_INVALID_PREFIX ) );
    ...
    function test_validate_typed_string_prefix_rejects_wrong_word2() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, wrong_word2, REASON_INVALID_PREFIX ) );
    ...
    function test_validate_typed_string_prefix_rejects_wrong_word3() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, wrong_word3, REASON_INVALID_PREFIX ) );
    ...
    function test_validate_TokenAmount_definition_rejects_too_short() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, short_string, REASON_TokenAmount_MISMATCH ) );
    ...
    function test_validate_TokenAmount_definition_rejects_zero_offset() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, valid, REASON_TokenAmount_MISMATCH ) );
    ...
    function test_validate_TokenAmount_definition_rejects_wrong_word1() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, wrong, REASON_TokenAmount_MISMATCH ) );
