...
import { Signing } from "@BondRoute/Signing.sol";
import { SameBlockExecution, BondExpired, BondAlreadySettled, InsufficientNativeFunding, BondValidationFailed, BondProtocolReverted, ExecutionData } from "@BondRoute/Core.sol";
import { BondNotFound, BondStatus } from "@BondRoute/Storage.sol";
...
import { InvalidTypedString, REASON_INVALID_PREFIX, REASON_TokenAmount_MISMATCH } from "@BondRoute/ValidationLib.sol";
 ...
 */
contract CoreHarness is Signing {
...
contract CoreTest is Test {
    ...
    function test_execute_bond_reverts_if_bond_not_found() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( BondNotFound.selector, commitment_hash, address(usdc), 100e6 ) );
    ...
    function test_signing_data_rejects_malicious_prefix() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, malicious_prefix, REASON_INVALID_PREFIX ) );
    ...
    function test_signing_data_rejects_malicious_TokenAmount() public
    {
        ...
        vm.expectRevert( abi.encodeWithSelector( InvalidTypedString.selector, malicious_type, REASON_TokenAmount_MISMATCH ) );
        core_harness.exposed_get_signing_data_for_execute_bond_as( execution_data );
    }
