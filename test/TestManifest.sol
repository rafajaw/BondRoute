...
interface IHashLibTests {
    ...
    // ─── calc_commitment_hash (Sentinel Structure) ─────────────────────────────
    function test_calc_commitment_hash_has_caffe0_prefix() external;
    function test_calc_commitment_hash_has_zero_padding() external;
    function test_calc_commitment_hash_different_stake_different_hash() external;

    // ─── is_valid_commitment_hash ──────────────────────────────────────────────
    function test_is_valid_commitment_hash_accepts_valid_hash() external;
    function test_is_valid_commitment_hash_rejects_wrong_stake_token() external;
    function test_is_valid_commitment_hash_rejects_wrong_stake_amount() external;
    function test_is_valid_commitment_hash_rejects_corrupted_hash() external;
    function test_is_valid_commitment_hash_rejects_zero_hash() external;
    function test_is_valid_commitment_hash_rejects_corrupted_sentinel() external;
}
...
interface IUserTests {
    ...
    function test_create_bond_reverts_on_invalid_commitment_hash_wrong_stake() external;
    function test_create_bond_reverts_on_invalid_commitment_hash_corrupted() external;
...
interface IProviderTests {
    ...
    // ─── airdrop() ───────────────────────────────────────────────────────────────
    function test_airdrop_native_token_transfers_to_collector_and_emits_event() external;
    function test_airdrop_erc20_transfers_to_collector_and_emits_event() external;
    function test_airdrop_reverts_on_native_amount_mismatch() external;
    function test_airdrop_message_only_emits_event_without_transfer() external;
    ...
    function test_transfer_funding_reverts_on_zero_address() external;
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// COLLECTOR.SOL - Expired bond liquidation
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// REENTRANCYLOCK.SOL - Bitmask-based reentrancy protection with explicit allowlists
// Implemented in: test/ReentrancyLock/ReentrancyLock.t.sol
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

interface IReentrancyLockTests {
    // ─── lockAndAllow() Tests ──────────────────────────────────────────────────────
    function test_lockAndAllow_allows_single_call() external;
    function test_lockAndAllow_reverts_on_same_lock_reentry() external;
    function test_lockAndAllow_reverts_on_different_lock_not_in_allowlist() external;
    function test_lockAndAllow_allows_reentry_when_in_allowlist() external;
    function test_lockAndAllow_clears_lock_after_execution() external;
    function test_lockAndAllow_allows_sequential_calls() external;

    // ─── lockAndAllowView() Tests ──────────────────────────────────────────────────
    function test_lockAndAllowView_allows_call_when_unlocked() external;
    function test_lockAndAllowView_reverts_when_same_lock_held() external;
    function test_lockAndAllowView_allows_when_caller_in_allowlist() external;

    // ─── Advanced Patterns ─────────────────────────────────────────────────────────
    function test_multibit_allowlist_allows_first_allowed_lock() external;
    function test_multibit_allowlist_allows_second_allowed_lock() external;
    function test_three_level_nesting_succeeds() external;
    function test_state_restored_after_nested_call() external;
    function test_revert_in_nested_call_preserves_outer_lock() external;
    function test_self_in_allowlist_allows_single_call() external;
    function test_self_in_allowlist_still_blocks_self_reentry() external;
    function test_double_lock_allows_single_call() external;
    function test_double_lock_blocks_self_reentry() external;
    function test_double_lock_blocks_when_inner_allows_only_one_bit() external;
    function test_double_lock_succeeds_when_inner_allows_both_bits() external;
}


// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// CROSS-FUNCTION REENTRANCY - ERC777 balance delta attack prevention
// Implemented in: test/ReentrancyLock/CrossFunctionReentrancy.t.sol
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

interface ICrossFunctionReentrancyTests {
    // ─── FROM CREATE_BOND → ALL TARGETS ────────────────────────────────────────────
    function test_create_bond_to_create_bond_blocked() external;
    function test_create_bond_to_execute_bond_blocked() external;
    function test_create_bond_to_liquidate_blocked() external;

    // ─── FROM EXECUTE_BOND → ALL TARGETS ───────────────────────────────────────────
    function test_execute_bond_to_create_bond_blocked() external;
    function test_execute_bond_to_execute_bond_blocked() external;
    function test_execute_bond_to_liquidate_blocked() external;

    // ─── FROM LIQUIDATE → ALL TARGETS ──────────────────────────────────────────────
    function test_liquidate_to_create_bond_blocked() external;
    function test_liquidate_to_execute_bond_blocked() external;
    function test_liquidate_to_liquidate_blocked() external;

    // ─── EXECUTE_BOND_AS (same lock as execute_bond) ───────────────────────────────
    function test_execute_bond_as_to_create_bond_blocked() external;
    function test_execute_bond_as_to_liquidate_blocked() external;
}
...
// - Gas Benchmarks:            100% (13/13)
//
// Pure BondRoute overhead (create_bond + execute_bond):
//    - Zero stake, warm protocol:   39,283 gas
//    - Zero stake, cold protocol:   43,283 gas
//    - Native stake, warm protocol: 52,868 gas
//    - Native stake, cold protocol: 56,868 gas
//    - ERC20 stake, warm protocol:  62,019 gas
//    - ERC20 stake, cold protocol:  66,019 gas
//
