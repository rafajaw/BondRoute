...
library SignatureValidator {
    ...
    function is_valid_signature( address signer, bytes32 _hash, bytes memory signature, bool is_eip1271 ) internal view returns ( bool )
    {
        ...
        // *NOTE*  -  Empty signatures are allowed to reach validation functions:
        //         -  For EIP-1271: some contracts do hash-based validation without signature data.
        //         -  For ECDSA: `tryRecover()` rejects invalid lengths, returning `InvalidSignatureLength` error.
